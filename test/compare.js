...
describe('compare', function() {
  it("should return true when the compared object's properties are equal", function() {
  ...
  it("should return false when the compared object's properties are not equal", function() {
    var obj1 = { 'one': 1, 'two': 2 };
